...
export const projects: Project[] = [
  ...
  {
    key: 'cliwright',
    title: 'cliwright — CLI Factory',
    featured: true,
    techTags: ['Go', 'Cobra', 'AI Agents', 'Code Generation', 'GoReleaser'],
  ...
  },
  {
    ...
    featured: true,
    showOnHomepage: false,
    techTags: ['Go', 'MCP', 'Telegram', 'Claude Code'],
    githubUrl: 'https://github.com/jjuanrivvera/tgctl-claude-channel',
  },
  {
    key: 'lsqueezy',
    title: 'lsqueezy — Lemon Squeezy CLI',
    featured: false,
    showOnHomepage: false,
    techTags: ['Go', 'Cobra', 'JSON:API', 'MCP', 'Homebrew'],
    githubUrl: 'https://github.com/jjuanrivvera/lemon-squeezy-cli',
    demoUrl: 'https://jjuanrivvera.github.io/lemon-squeezy-cli/',
  },
  {
    key: 'adguardCli',
    title: 'AdGuard Home CLI',
    featured: false,
    showOnHomepage: false,
    techTags: ['Go', 'Cobra', 'DNS', 'Homelab'],
    githubUrl: 'https://github.com/jjuanrivvera/adguard-cli',
